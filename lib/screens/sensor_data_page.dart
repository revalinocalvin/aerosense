...
class _SensorDataPageState extends State<SensorDataPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // *** THE FINAL FIX - PART 1 ***
      // We are making the Scaffold's own background transparent. This is a
      // "belt and suspenders" approach to ensure it doesn't try to paint any
      // color in the bottom inset.
      backgroundColor: Colors.transparent,
      // *** THE FINAL FIX - PART 2 ***
      // This allows the body to draw behind the navigation bar.
      extendBody: true,
      body: Stack(
        children: [
          // This container with the gradient will now be the only background.
          Container(
